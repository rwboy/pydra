...
class Module(framework.Framework):
    ...
    def aes_decrypt(self, ciphertext, key, iv):
        ...
        password = lib.aes.decryptData(key, iv.encode('utf-8') + decoded)
    ...
    def get_resolver(self):
        resolver = lib.dns.resolver.get_default_resolver()
    ...
    def module_thread(self, obj, *args):
        fuc = getattr(self, obj)
        fuc(args)
        pass
